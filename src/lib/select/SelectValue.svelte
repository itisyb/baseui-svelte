<script lang="ts">
  ...
  interface Props extends Omit<HTMLAttributes<HTMLSpanElement>, 'children'> { children?: Snippet<[string | null, string | undefined]>; placeholder?: string; ref?: HTMLSpanElement | null; }
