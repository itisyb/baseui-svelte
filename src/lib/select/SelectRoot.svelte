<script lang="ts">
  ...
  export interface Props { children?: Snippet; value?: string | null; open?: boolean; onValueChange?: OnValueChange<string, 'item-press' | 'keyboard'>; onOpenChange?: OnValueChange<boolean, PopoverOpenReason>; name?: string; disabled?: boolean; required?: boolean; }
