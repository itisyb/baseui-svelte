<script lang="ts">
  ...
  export interface Props extends Omit<HTMLAttributes<HTMLDivElement>, 'children'> { children?: Snippet; orientation?: Orientation; direction?: Direction; loop?: boolean; ref?: HTMLDivElement | null; }
