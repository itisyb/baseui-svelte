<script lang="ts">
  ...
  export interface Props extends Omit<HTMLAttributes<HTMLDivElement>, 'children'> { children?: Snippet; disabled?: boolean; closeOnClick?: boolean; onSelect?: (event: Event) => void; textValue?: string; ref?: HTMLDivElement | null; }
