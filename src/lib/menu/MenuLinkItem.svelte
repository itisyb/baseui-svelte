<script lang="ts">
  ...
  export interface Props extends Omit<HTMLAnchorAttributes, 'children'> { children?: Snippet; href: string; disabled?: boolean; textValue?: string; ref?: HTMLAnchorElement | null; }
