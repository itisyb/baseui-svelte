<script lang="ts">
  ...
  interface Props extends Omit<HTMLAttributes<HTMLDivElement>, 'children'> { children?: Snippet; orientation?: Orientation; loopFocus?: boolean; modal?: boolean; disabled?: boolean; ref?: HTMLDivElement | null; }
